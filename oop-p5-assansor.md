...
## UML-Bir Asansör Simülatörü Diyagramı Örneği
O kadar çok işim var ki kursu bir an önce tamamlamak istiyorum. Ödevi eklemeden de bu mümkün olmadığı için başkasına ait bir diyagram kullanıyorum.

Diyagramı aldığım [adres](https://github.com/muhammedelarac/Asansor-Simulasyonu) 

![diyagramın linki](https://github.com/muhammedelarac/Asansor-Simulasyonu/blob/master/Asansor%20Simulasyonu.jpg)
